...
chat_completion = client.chat.completions.create(
   ...
   messages=[
        {"role": "system", 
         "content": "You are a Recruiter. Find the top 10 best candidates for the provided Job Description. Follow the schema provided below to extract the relevant details. Do not invent information that is not in the provided text. Output JSON only."},
        {"role": "user",
